...
<span style="">{{permanency + ' ' + 'on chart'}}</span></span>
    ...
    <div slot="extension">
        <z-spot button class="butt2" size=s style="font-size: 18px; border-width: 4px; background-color: #D4D7DD;" :style="'color:' + sharedState.colorMe.sec" :distance="120" :angle="45" :label="activePage ? 'insights' : 'return'" @click.native="toggle">
        ...
        <z-spot button class="butt2" size=s label="☝️ star it" style="font-size: 25px; border-width: 4px; background-color: #D4D7DD;" :style="'color:' + sharedState.colorMe.sec" :distance="120" :angle="135" @mouseup.native="toLink($zircle.getParams().data.url)">
